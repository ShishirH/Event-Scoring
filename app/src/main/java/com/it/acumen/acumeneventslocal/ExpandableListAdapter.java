...
//                R3.setInputType(InputType.TYPE_CLASS_NUMBER);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String messageToDisplay = "Round1 Score : "+String.valueOf(childItem.getRound1Score())+"\n"+
                        "Round2 Score : "+String.valueOf(childItem.getRound2Score())+"\n"+"Round3 Score : "+String.valueOf(childItem.getRound3Score())
                        +"\nSure to submit?\n(Use update and reset if you have issues)";
                ...
                builder.setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                          ...
                          //      Toast.makeText(_context, "Submitted!!", Toast.LENGTH_SHORT).show();
                                ...
                                try {
                                    url.put("url","http://192.168.43.224:8000/andy/events/endgame");
